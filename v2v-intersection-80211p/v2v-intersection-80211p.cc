...
main (int argc, char *argv[])
{
  ...
  /*** 0.a App Options ***/
  std::string sumo_folder = "scratch/v2v-intersection-cv2x/sumo_inter1/";
  std::string mob_trace = "inter1.rou.xml";
  std::string sumo_config ="scratch/v2v-intersection-cv2x/sumo_inter1/inter1.sumocfg";

  bool verbose = true;
  bool realtime = false;
  bool sumo_gui = true;
  double sumo_updates = 0.01;
  std::string csv_name = "v2v-inter1-80211p";
  std::string csv_name_cumulative = "v2v-inter1-80211p-cum";
