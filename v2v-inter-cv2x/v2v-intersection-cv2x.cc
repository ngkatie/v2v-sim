...
main (int argc, char *argv[])
{
  ...
  std::string sumo_folder = "scratch/v2v-intersection-cv2x/sumo_inter/";
  std::string mob_trace = "inter.rou.xml";
  std::string sumo_config ="scratch/v2v-intersection-cv2x/sumo_inter/inter.sumocfg";
  ...
  std::string csv_name = "cv2x";
  std::string csv_name_cumulative = "cv2x-cum";
