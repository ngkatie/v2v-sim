...
main (int argc, char *argv[])
{
  ...
  /*** 0.a App Options ***/
  std::string sumo_folder = "scratch/v2v-intersection-80211p/sumo_inter/";
  std::string mob_trace = "inter.rou.xml";
  std::string sumo_config ="scratch/v2v-intersection-80211p/sumo_inter/inter.sumocfg";

  bool verbose = true;
  bool realtime = false;
  bool sumo_gui = true;
  double sumo_updates = 0.01;
  std::string csv_name = "80211p";
  std::string csv_name_cumulative = "80211p-cum";
